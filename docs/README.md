...
本项目是一份面向自然语言处理（NLP）领域的综合学习笔记，特别关注情感分析和虚假信息检测两个重要方向。旨在帮助新入学的硕士生和博士生快速了解学术研究的基础知识，掌握必要的研究技能，并在NLP领域建立扎实的学术基础。
...
- [附录C SCI论文配图绘制指南](./docs/appendix/matlab_guidelines.md)
